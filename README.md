...
> This fork is documented for local repo usage. One-click MCP install badges for Cursor, LM Studio, and Kiro were
> removed here because they point at the published upstream npm package, not your local checkout or fork.
